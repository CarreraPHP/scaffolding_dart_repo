import 'package:scaffolding_api/model/user.dart';
import 'package:scaffolding_api/scaffolding_api.dart';
import 'package:aqueduct_test/aqueduct_test.dart';

export 'package:scaffolding_api/scaffolding_api.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for scaffolding_api.
///
...
///         }
///
class Harness extends TestHarness<ScaffoldingApiChannel> with TestHarnessAuthMixin<ScaffoldingApiChannel>, TestHarnessORMMixin {
  @override
